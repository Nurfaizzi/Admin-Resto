...
const CompMenu = () => {
  ...
  const {createNewMenu} = useSelector((state) => state)
  ...
  useEffect(() => {
    dispatch(handleGetAllMenu(type, filterName,pagination.currentPage,setPagination));
  ...
  return (
    <div className=" border-red h-screen flex-column justify-center items-center bg-white ">
      ...
      {deleteSucces ? <p className=" flex text-white bg-green-500  xl:text-center xl:p-8 xl:justify-center xl:m-auto xl:w-96 sm:w-96 sm:mt-8 lg:text-center lg:p-8 lg:justify-center lg:m-auto sm:text-center sm:p-8 sm:justify-center sm:m-auto ">Data Berhasil Dihapus</p> : null}
            ...
            <div className=" sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 border-blue-500 sm-items-center">
              <div className="flex-col object-fill">
                <div className="md:shrink-0 ">
                  <img className="object-fill h-48 w-96 " src={obj.imageUrl} />
                  <div className="flex md:gap-2  lg:gap-6 sm:gap-6 items-center justify-center pb-3 pt-3 ">
                    ...
                    <button onClick={handleShowModal} className="text-white bg-red-500 border border-red-500 py-1.5 px-3 rounded-xl">
                      Delete
                    </button>

                    <Modal isShowModal={showModal} onClose={CloseModal} >
                  <div className="">
                  <h1 className="flex text-center justify-center text-3xl ">Are you sure?</h1>
                  <p className="flex text-red-500 text-lg font-semibold text-center justify-center xl:pt-0 sm:mt-8 ">DELETE MENU</p>
                  <a href="#menu">
                  <button className=" sm:ml-6 sm:mr-3 sm:w-28 sm:mt-8 text-white bg-blue-500 border border-blue-500 py-1.5 px-3 rounded-xl mr-0 mt-8 justify-center flex-rows  xl:w-28 xl:ml-0 xl:mt-3 xl:mr-3" onClick={(e) => handleDelete (obj.id)}>Yes</button>
                  <button className="text-white bg-red-500 border border-red-500 py-1.5 px-3 rounded-xl xl:w-28 sm:w-28">Cancel</button>
                  </a>
                ...
                <div className="p-8 ">
                  ...
                  <p className="mt-2 text-blue-500 pb-3">Rp.{obj.price}.000</p>
  ...
  <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
    ...
    <div>
      <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
        <a href="#menu" className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
          <span className="sr-only">Previous</span>
          <button onClick={handlePreviousPage}  >Previous</button>
        </a>
    
        <a href="#menu" className="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
  
         <button onClick={handleNextPage} disabled={!!pagination.nextPage === 0}>Next</button>
        </a>
      </nav>
    </div>
  </div>
